...
## Exercise 12
    Use git remote show [remote-name] to see detailed information about a remote
...
## Exercise 14
    ...
    Alias: git switch (for branches) and git restore (for files)
...
## Exercise 18
    ...
    Revert: Creates a new commit that undoes the changes from a previous commit (safer for shared history)
